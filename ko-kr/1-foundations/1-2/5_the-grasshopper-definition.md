...
> Example files that accompany this section: \[Download]\(../../appendix/A-2/gh-files/1.2.5\_the grasshopper definition.gh)
{% endif %}
...
\####1.2.5.1. PROGRAM FLOW Grasshopper visual programs are executed from left to right. Reading the graph relative to the wired connections from upstream to downstream provides understanding about the Program Flow.

![IMAGE](../../.gitbook/assets/1-2-5_001-program-flow.png)
...
![IMAGE](../../.gitbook/assets/1-2-5_002-logical-graph.png)
...
![IMAGE](../../.gitbook/assets/1-2-5_003-lofted-variable-circles.png)
