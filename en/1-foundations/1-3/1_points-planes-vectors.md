...
![Points](../../.gitbook/assets/1-3-1_002-points.png)
...
\####1.3.1.2. VECTORS A vector is a geometric quantity describing Direction and Magnitude. Vectors are abstract; ie. they represent a quantity, not a geometrical element.
...
![Vectors](../../.gitbook/assets/1-3-1_003-vectors.png)

\####1.3.1.3. PLANES Planes are “Flat” and extend infinitely in two directions, defining a local coordinate system. Planes are not genuine objects in Rhino, they are used to define a coordinate system in 3D world space. In fact, it’s best to think of planes as vectors, they are merely mathematical constructs.

![Planes](../../.gitbook/assets/1-3-1_004-planes.png)
